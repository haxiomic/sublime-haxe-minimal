...
class HaxeBuildCommand(_HaxeBuildCommand_VariantsWindowCommand):
    ...
    def run(self,args = None,run_after_build = None):
...
class HaxeServerStdio:
    ...
    def build(self,hxml,timeout_s = None):
            ...
            while True:
                ...
                while (bytesRemaining > 0):
                    ...
                    if (pipeBytes is None):
                        ...
                        messageBuffer.b.extend(pipeBytes.b)
                if pipeDead:
...
class HaxeView(sublime_plugin_ViewEventListener):
    ...
    def on_query_completions(self,prefix,locations):
        ...
        if (not result.hasError):
            ...
            if ((xml.nodeType != Xml.Document) and ((xml.nodeType != Xml.Element))):
                raise _HxException(("Invalid nodeType " + HxOverrides.stringOrNull((("null" if ((xml.nodeType is None)) else _Xml_XmlType_Impl_.toString(xml.nodeType))))))
            this1 = xml
            x = this1
            maxDisplayLength = 50
            overflowSuffix = " …  "
            ...
            if haxe_xml__Access_HasNodeAccess_Impl_.resolve(x,"list"):
                ...
                while (_g < len(_g1)):
                    ...
                    if (_hx_local_2 == 3):
                        ...
                        info = kind
                    completion = name
                    haxe_Log.trace(item,_hx_AnonObject({'fileName': "src/HaxeView.hx", 'lineNumber': 118, 'className': "HaxeView", 'methodName': "on_query_completions"}))
                    if (kind == "method"):
                        func = SyntaxTools.parseHaxeFunctionSignature(_hx_type)
                        if (((func.parameters[0] if 0 < len(func.parameters) else None) is not None) and (((func.parameters[0] if 0 < len(func.parameters) else None).type == "Void"))):
                        ...
                        display1 = ((((("" + HxOverrides.stringOrNull((("?" if (func.optional) else "")))) + ("null" if name is None else name)) + "(") + ("null" if parametersFormatted is None else parametersFormatted)) + ")")
                        i = [1]
                ...
                while (_g2 < len(_g11)):
                    ...
                    if (type1 is not None):
                        ...
                        if (len(t.parameters) > 0):
                            kind3 = "method"
                            if (((t.parameters[0] if 0 < len(t.parameters) else None) is not None) and (((t.parameters[0] if 0 < len(t.parameters) else None).type == "Void"))):
                                _this4 = t.parameters
                                if (len(_this4) != 0):
                                    _this4.pop(0)
                            _this5 = t.parameters
                            ...
                            info3 = t.returnType
                            display3 = ((((("" + HxOverrides.stringOrNull((("?" if (t.optional) else "")))) + ("null" if name1 is None else name1)) + "(") + ("null" if parametersFormatted1 is None else parametersFormatted1)) + ")")
                            i2 = [1]
                            _this7 = t.parameters
                            def _hx_local_20(i3):
                                def _hx_local_15(p3):
        ...
        try:
            if (not result.hasError):
                ...
                if ((x.nodeType != Xml.Document) and ((x.nodeType != Xml.Element))):
                    raise _HxException(("Invalid nodeType " + HxOverrides.stringOrNull((("null" if ((x.nodeType is None)) else _Xml_XmlType_Impl_.toString(x.nodeType))))))
                this1 = x
                x1 = this1
            ...
            _hx_e1 = _hx_e.val if isinstance(_hx_e, _HxException) else _hx_e
            e = _hx_e1
            haxe_Log.trace(("on_hover error: " + HxOverrides.stringOrNull((("null" if ((e is None)) else Std.string(e))))),_hx_AnonObject({'fileName': "src/HaxeView.hx", 'lineNumber': 259, 'className': "HaxeView", 'methodName': "on_hover"}))
    ...
    def generateFunctionCompletion(name,func):
        ...
        return _hx_AnonObject({'info': info, 'display': ((((("" + ("null" if display is None else display)) + ("null" if name is None else name)) + "(") + ("null" if parametersFormatted is None else parametersFormatted)) + ")"), 'completion': (((("" + ("null" if name is None else name)) + "(") + HxOverrides.stringOrNull(", ".join([python_Boot.toString1(x1,'') for x1 in snippetArguments]))) + ")")})
...
class SyntaxTools:
    ...
    @staticmethod
    def scopeAwareSplit(string,delimiter,scopeIncreaseChars = None,scopeDecreaseChars = None):
    ...
    @staticmethod
    def unwrap(string,openChar,closeChar,recursive = None):
    ...
    def parseHaxeFunctionSignature(signature):
        parameters = None
        optional = None
        if (signature.startswith("Null<") and signature.endswith(">")):
            optional = True
            signature = HxString.substr(signature,len("Null<"),None)
            signature = HxString.substr(signature,0,(len(signature) - 1))
        else:
            optional = False
        arrowMarker = "\x1F"
        ...
        if (len(arrowParts) > 0):
            ...
            parameters = []
        returnType = StringTools.replace(returnType,arrowMarker,"->")
        return _hx_AnonObject({'parameters': parameters, 'returnType': returnType, 'optional': optional})
...
class Xml:
    ...
    def get(self,att):
        if (self.nodeType != Xml.Element):
            raise _HxException(("Bad node type, expected Element but found " + HxOverrides.stringOrNull((("null" if ((self.nodeType is None)) else _Xml_XmlType_Impl_.toString(self.nodeType))))))
    ...
    def elementsNamed(self,name):
        if ((self.nodeType != Xml.Document) and ((self.nodeType != Xml.Element))):
            raise _HxException(("Bad node type, expected Element or Document but found " + HxOverrides.stringOrNull((("null" if ((self.nodeType is None)) else _Xml_XmlType_Impl_.toString(self.nodeType))))))
        _g = []
        _g1 = 0
        _g2 = self.children
        while (_g1 < len(_g2)):
            ...
            if (child.nodeType == Xml.Element):
                if (child.nodeType != Xml.Element):
                    raise _HxException(("Bad node type, expected Element but found " + HxOverrides.stringOrNull((("null" if ((child.nodeType is None)) else _Xml_XmlType_Impl_.toString(child.nodeType))))))
                tmp = (child.nodeName == name)
            else:
                tmp = False
            if tmp:
                _g.append(child)
        return haxe_iterators_ArrayIterator(_g)
    ...
    def createElement(name):
        ...
        if (xml.nodeType != Xml.Element):
            raise _HxException(("Bad node type, expected Element but found " + HxOverrides.stringOrNull((("null" if ((xml.nodeType is None)) else _Xml_XmlType_Impl_.toString(xml.nodeType))))))
        xml.nodeName = name
        return xml
    ...
    def createPCData(data):
        ...
        if ((xml.nodeType == Xml.Document) or ((xml.nodeType == Xml.Element))):
            raise _HxException(("Bad node type, unexpected " + HxOverrides.stringOrNull((("null" if ((xml.nodeType is None)) else _Xml_XmlType_Impl_.toString(xml.nodeType))))))
        xml.nodeValue = data
        return xml
        ...
        if (x is None):
            ...
            if (this1.nodeType == Xml.Document):
                ...
                if (this1.nodeType != Xml.Element):
                    raise _HxException(("Bad node type, expected Element but found " + HxOverrides.stringOrNull((("null" if ((this1.nodeType is None)) else _Xml_XmlType_Impl_.toString(this1.nodeType))))))
    ...
    def resolve(this1,name):
        ...
        while x.hasNext():
            ...
            if ((x1.nodeType != Xml.Document) and ((x1.nodeType != Xml.Element))):
                raise _HxException(("Invalid nodeType " + HxOverrides.stringOrNull((("null" if ((x1.nodeType is None)) else _Xml_XmlType_Impl_.toString(x1.nodeType))))))
            l.append(x1)
        return l
...
class haxe_xml__Access_Access_Impl_:
    ...
    def get_innerData(this1):
        if ((this1.nodeType != Xml.Document) and ((this1.nodeType != Xml.Element))):
            raise _HxException(("Bad node type, expected Element or Document but found " + HxOverrides.stringOrNull((("null" if ((this1.nodeType is None)) else _Xml_XmlType_Impl_.toString(this1.nodeType))))))
        it = haxe_iterators_ArrayIterator(this1.children)
        if (not it.hasNext()):
            tmp = None
            if (this1.nodeType == Xml.Document):
                tmp = "Document"
        ...
        if it.hasNext():
            ...
            if ((v.nodeType == Xml.PCData) and ((n.nodeType == Xml.CData))):
                if ((v.nodeType == Xml.Document) or ((v.nodeType == Xml.Element))):
                    raise _HxException(("Bad node type, unexpected " + HxOverrides.stringOrNull((("null" if ((v.nodeType is None)) else _Xml_XmlType_Impl_.toString(v.nodeType))))))
            ...
            if tmp1:
                if (not it.hasNext()):
                    if ((n.nodeType == Xml.Document) or ((n.nodeType == Xml.Element))):
                        raise _HxException(("Bad node type, unexpected " + HxOverrides.stringOrNull((("null" if ((n.nodeType is None)) else _Xml_XmlType_Impl_.toString(n.nodeType))))))
                    return n.nodeValue
                n2 = it.next()
                tmp2 = None
                if (n2.nodeType == Xml.PCData):
                    if ((n2.nodeType == Xml.Document) or ((n2.nodeType == Xml.Element))):
                        raise _HxException(("Bad node type, unexpected " + HxOverrides.stringOrNull((("null" if ((n2.nodeType is None)) else _Xml_XmlType_Impl_.toString(n2.nodeType))))))
    ...
    def get_innerHTML(this1):
        ...
        while (_g_current < len(_this)):
            ...
            s_b.write(Std.string(haxe_xml_Printer.print((_this[x] if x >= 0 and x < len(_this) else None))))
        return s_b.getvalue()
            ...
            if (state1 == 0):
                ...
                if (not (((((((((c >= 97) and ((c <= 122))) or (((c >= 65) and ((c <= 90))))) or (((c >= 48) and ((c <= 57))))) or ((c == 58))) or ((c == 46))) or ((c == 95))) or ((c == 45))))):
                    ...
                    if (parent.nodeType != Xml.Element):
                        raise _HxException(("Bad node type, expected Element but found " + HxOverrides.stringOrNull((("null" if ((parent.nodeType is None)) else _Xml_XmlType_Impl_.toString(parent.nodeType))))))
...
class haxe_xml_Printer:
    ...
    def writeNode(self,value,tabs):
        ...
        if (_g == 0):
            ...
            if (value.nodeType != Xml.Element):
                raise _HxException(("Bad node type, expected Element but found " + HxOverrides.stringOrNull((("null" if ((value.nodeType is None)) else _Xml_XmlType_Impl_.toString(value.nodeType))))))
            _this1 = self.output
            ...
            if self.hasChildren(value):
                ...
                if ((value.nodeType != Xml.Document) and ((value.nodeType != Xml.Element))):
                    raise _HxException(("Bad node type, expected Element or Document but found " + HxOverrides.stringOrNull((("null" if ((value.nodeType is None)) else _Xml_XmlType_Impl_.toString(value.nodeType))))))
                _this4 = value.children
                _g_current = 0
                while (_g_current < len(_this4)):
                    child = _g_current
                    _g_current = (_g_current + 1)
                    self.writeNode((_this4[child] if child >= 0 and child < len(_this4) else None),((("null" if tabs is None else tabs) + "\t") if (self.pretty) else tabs))
                _this5 = self.output
            ...
            if ((value.nodeType == Xml.Document) or ((value.nodeType == Xml.Element))):
                raise _HxException(("Bad node type, unexpected " + HxOverrides.stringOrNull((("null" if ((value.nodeType is None)) else _Xml_XmlType_Impl_.toString(value.nodeType))))))
            ...
            if ((value.nodeType != Xml.Document) and ((value.nodeType != Xml.Element))):
                raise _HxException(("Bad node type, expected Element or Document but found " + HxOverrides.stringOrNull((("null" if ((value.nodeType is None)) else _Xml_XmlType_Impl_.toString(value.nodeType))))))
            _this14 = value.children
            _g_current1 = 0
            while (_g_current1 < len(_this14)):
                child1 = _g_current1
                _g_current1 = (_g_current1 + 1)
                self.writeNode((_this14[child1] if child1 >= 0 and child1 < len(_this14) else None),tabs)
        else:
            pass
    ...
    def hasChildren(self,value):
        ...
        while (_g_current < len(_this)):
            child = _g_current
            _g_current = (_g_current + 1)
            child1 = (_this[child] if child >= 0 and child < len(_this) else None)
            _g = child1.nodeType
            if ((_g == 1) or ((_g == 0))):
                return True
            elif ((_g == 3) or ((_g == 2))):
                if ((child1.nodeType == Xml.Document) or ((child1.nodeType == Xml.Element))):
                    raise _HxException(("Bad node type, unexpected " + HxOverrides.stringOrNull((("null" if ((child1.nodeType is None)) else _Xml_XmlType_Impl_.toString(child1.nodeType))))))
